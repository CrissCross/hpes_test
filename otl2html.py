...
def divName(line):
    ...
    if (line[0] == '_'):
        ...
        line = line[1:]
    line = line.replace(' ', '_')
    return'<div class="container ' + line + '">'
                ...
                if (silentdiv == 0):
                    ...
                    if (styleSheet != ""):
                        if (lineLevel == linein.find("- ") + 1):
                            ...
                            print "><div class=\"L" + str(lineLevel) + "\"",
                            print ">" + linein.strip() + "</div>",
                else:
                    silentdiv = 0
        else:
            if (lineLevel == 1):
...
def printHeader(linein):
    ...
    print """<!DOCTYPE html><html><head><meta charset='utf-8'><title>""" + getTitleText(linein) + "</title></head>"
    print """<script type=\"text/javascript\" src=\"jquery-1.11.2.min.js\"></script>"""
    print """<script type=\"text/javascript\" src=\"wookmark.min.js\"></script>"""
